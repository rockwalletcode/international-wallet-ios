...
internal enum L10n {
  ...
  internal enum Account {
    ...
    internal static let confirmYourInformation = L10n.tr("Localizable", "Account.confirmYourInformation", fallback: "Confirm your information")
    /// Contact us
    ...
    internal static let enterYourPhoneNumber = L10n.tr("Localizable", "Account.EnterYourPhoneNumber", fallback: "Let’s get your phone verified")
    /// To ensure that you can access all the features of our app, we need to verify your phone number. We'll send you a code via SMS
    internal static let enterYourPhoneNumberSubtitle = L10n.tr("Localizable", "Account.EnterYourPhoneNumberSubtitle", fallback: "To ensure that you can access all the features of our app, we need to verify your phone number. We'll send you a code via SMS")
    /// $10000 per BTC
    ...
    /// Get verified
    internal static let getVerified = L10n.tr("Localizable", "Account.GetVerified", fallback: "Get verified")
    ...
    internal static let otherPaymentOptions = L10n.tr("Localizable", "Account.OtherPaymentOptions", fallback: "Other Payment Options")
    /// Other withdrawal options
    internal static let otherWithdrawalOptions = L10n.tr("Localizable", "Account.otherWithdrawalOptions", fallback: "Other withdrawal options")
    ...
    /// Payment Options
    internal static let paymentOptions = L10n.tr("Localizable", "Account.PaymentOptions", fallback: "Payment Options")
    /// Pending
    ...
    /// Please check that all your details are correct before submiting
    internal static let submitPersonalInfoDisclaimer = L10n.tr("Localizable", "Account.submitPersonalInfoDisclaimer", fallback: "Please check that all your details are correct before submiting")
    ...
    internal static let termsDescription = L10n.tr("Localizable", "Account.TermsDescription", fallback: "By Signing in, you agree to the following:")
    ...
    /// I agree to RockWallet PRO’s
    internal static let termsTickboxPro = L10n.tr("Localizable", "Account.TermsTickboxPro", fallback: "I agree to RockWallet PRO’s")
    ...
    /// Withdrawal Options
    internal static let withdrawalOptions = L10n.tr("Localizable", "Account.withdrawalOptions", fallback: "Withdrawal Options")
    ...
    internal enum IncorrectSsn {
      /// Unfortunately, we were unable to verify your social security number. Try with a different method of verification or contact support.
      internal static let description = L10n.tr("Localizable", "Account.IncorrectSsn.description", fallback: "Unfortunately, we were unable to verify your social security number. Try with a different method of verification or contact support.")
    ...
    internal enum InfoDialog {
      ...
      /// ・Send, Receive and Store your crypto assets
      internal static func fullVerification(_ p1: Any, _ p2: Any, _ p3: Any) -> String {
    ...
    internal enum Limits {
      ...
      /// Express verification offers a one-time limit. To renew, upgrade your limits.
    ...
    internal enum Prompts {
      internal enum PendingVerification {
        /// Verification in process
        internal static let status = L10n.tr("Localizable", "Account.Prompts.PendingVerification.Status", fallback: "Verification in process")
        /// Verification might take a few minutes please come back later to check your account status
        internal static let subtitle = L10n.tr("Localizable", "Account.Prompts.PendingVerification.Subtitle", fallback: "Verification might take a few minutes please come back later to check your account status")
      }
    }
    internal enum ReviewingInformation {
      /// Verification might take a few extra minutes. We will notify you when we are done.
      internal static let description = L10n.tr("Localizable", "Account.ReviewingInformation.description", fallback: "Verification might take a few extra minutes. We will notify you when we are done.")
      /// We are still reviewing your information...
      internal static let title = L10n.tr("Localizable", "Account.ReviewingInformation.title", fallback: "We are still reviewing your information...")
    }
    ...
    internal enum VerificationUnsuccessful {
      ...
      internal static let title = L10n.tr("Localizable", "Account.VerificationUnsuccessful.Title", fallback: "We’re sorry, we can’t verify your account.")
    }
  ...
  internal enum Button {
    ...
    internal static let anotherVerificationMethod = L10n.tr("Localizable", "Button.anotherVerificationMethod", fallback: "Try another verification method")
    /// Authorize
    ...
    /// I changed my mind
    internal static let changeMyMind = L10n.tr("Localizable", "Button.ChangeMyMind", fallback: "I changed my mind")
    /// Close button
    ...
    /// Edit
    internal static let edit = L10n.tr("Localizable", "Button.edit", fallback: "Edit")
    /// Finish button title
    ...
    /// Go to home
    internal static let goToHome = L10n.tr("Localizable", "Button.GoToHome", fallback: "Go to home")
    ...
    /// Send code
    internal static let sendCode = L10n.tr("Localizable", "Button.SendCode", fallback: "Send code")
  ...
  internal enum Buy {
    ...
    /// Buy fee
    internal static let buyFee = L10n.tr("Localizable", "Buy.buyFee", fallback: "Buy fee")
    /// Buy limits
    ...
    /// Express limit exceeded increase your limits to continue
    internal static let expressLimitExceeded = L10n.tr("Localizable", "Buy.ExpressLimitExceeded", fallback: "Express limit exceeded increase your limits to continue")
    ...
    /// Order preview title
    internal static let orderPreview = L10n.tr("Localizable", "Buy.OrderPreview", fallback: "Buy preview")
    ...
    internal enum BuyLimits {
      ...
      /// To further increase your limits, press on the 'Increase Your Limits' button below.
      internal static let increase = L10n.tr("Localizable", "Buy.BuyLimits.Increase", fallback: "To further increase your limits, press on the 'Increase Your Limits' button below.")
      internal enum Description {
        ...
        internal enum Lifetime {
          /// Minimum for Buy is %@ per transaction and you have a lifetime limit of %@.
          internal static func android(_ p1: Any, _ p2: Any) -> String {
            return L10n.tr("Localizable", "Buy.BuyLimits.description.lifetime.android", String(describing: p1), String(describing: p2), fallback: "Minimum for Buy is %@ per transaction and you have a lifetime limit of %@.")
          }
        }
      }
    }
  ...
  internal enum ComingSoon {
    ...
    internal enum FeatureUnavailable {
      /// This feature is not currently available in your region. We will notify you when it becomes available.
      internal static let subtitle = L10n.tr("Localizable", "ComingSoon.FeatureUnavailable.Subtitle", fallback: "This feature is not currently available in your region. We will notify you when it becomes available.")
    }
    internal enum Buttons {
      /// Back to home
  ...
  internal enum CommonString {
    /// Approved
    internal static let approved = L10n.tr("Localizable", "CommonString.Approved", fallback: "Approved")
    /// Free
    internal static let free = L10n.tr("Localizable", "CommonString.Free", fallback: "Free")
    /// Go to home
    internal static let goToHome = L10n.tr("Localizable", "CommonString.goToHome", fallback: "Go to home")
    /// Safari
    internal static let safari = L10n.tr("Localizable", "CommonString.Safari", fallback: "Safari")
    internal enum EndingOn {
      /// Ending on
      internal static let title = L10n.tr("Localizable", "CommonString.EndingOn.title", fallback: "Ending on")
    }
    internal enum Or {
      /// Or
      internal static let label = L10n.tr("Localizable", "CommonString.Or.label", fallback: "Or")
    }
    internal enum StartingOn {
      /// Starting on
      internal static let title = L10n.tr("Localizable", "CommonString.StartingOn.title", fallback: "Starting on")
    }
  }
  ...
  internal enum ErrorMessages {
    ...
    internal static func amountTooHigh(_ p1: Any, _ p2: Any, _ p3: Any) -> String {
      return L10n.tr("Localizable", "ErrorMessages.AmountTooHigh", String(describing: p1), String(describing: p2), String(describing: p3), fallback: "The amount is higher than your remaining %@ limit of %@ %@. Please upgrade your account or enter a lower amount.")
    }
    ...
    /// The amount is higher than your current balance. Please enter a lower amount or add more funds.
    internal static let depositBalance = L10n.tr("Localizable", "ErrorMessages.DepositBalance", fallback: "The amount is higher than your current balance. Please enter a lower amount or add more funds.")
    ...
    internal enum Sell {
      ...
      internal enum SsnInput {
        ...
        /// Please make sure your last 4 digits of your Social Security Number are correct and try again
        internal static let incorrectSsn2 = L10n.tr("Localizable", "ErrorMessages.Sell.SsnInput.IncorrectSsn2", fallback: "Please make sure your last 4 digits of your Social Security Number are correct and try again")
      }
    }
  ...
  internal enum GenerateStatement {
    /// Generate Statement
    internal static let title = L10n.tr("Localizable", "GenerateStatement.Title", fallback: "Generate Statement")
    internal enum Buttons {
      internal enum Generate {
        /// Generate
        internal static let title = L10n.tr("Localizable", "GenerateStatement.Buttons.Generate.title", fallback: "Generate")
      }
    }
  }
  internal enum HomeScreen {
    ...
    internal enum CryptoBalance {
      /// Crypto balance
      internal static let title = L10n.tr("Localizable", "HomeScreen.CryptoBalance.title", fallback: "Crypto balance")
    }
    internal enum UsdBalance {
      /// USD Account Balance
      internal static let title = L10n.tr("Localizable", "HomeScreen.UsdBalance.title", fallback: "USD Account Balance")
    }
  }
  ...
  internal enum Limits {
    /// Sell to ACH
    internal static let sellToACH = L10n.tr("Localizable", "Limits.SellToACH", fallback: "Sell to ACH")
    /// Sell to card
    internal static let sellToCard = L10n.tr("Localizable", "Limits.SellToCard", fallback: "Sell to card")
  }
  ...
  internal enum OtherPaymentMethods {
    /// Buying via ACH or Card may result in:
    /// ・A delay of 1–5 business days for fund arrival
    /// ・Potential additional fees
    internal static let buyDisclaimer = L10n.tr("Localizable", "OtherPaymentMethods.BuyDisclaimer", fallback: "Buying via ACH or Card may result in:\n・A delay of 1–5 business days for fund arrival\n・Potential additional fees")
    /// Withdrawing via ACH or Card may result in:
    /// ・A delay of 1–5 business days for fund arrival
    /// ・Potential additional fees
    internal static let withdrawalDisclaimer = L10n.tr("Localizable", "OtherPaymentMethods.WithdrawalDisclaimer", fallback: "Withdrawing via ACH or Card may result in:\n・A delay of 1–5 business days for fund arrival\n・Potential additional fees")
  }
  ...
  internal enum PaymentMethods {
    /// ACH
    internal static let ach = L10n.tr("Localizable", "PaymentMethods.ACH", fallback: "ACH")
    /// Select a card
    internal static let selectACard = L10n.tr("Localizable", "PaymentMethods.SelectACard", fallback: "Select a card")
  }
  internal enum PaymentOptions {
    /// How would you like to buy?
    internal static let payment = L10n.tr("Localizable", "PaymentOptions.payment", fallback: "How would you like to buy?")
    /// Where would you like your funds to go?
    internal static let withdrawal = L10n.tr("Localizable", "PaymentOptions.withdrawal", fallback: "Where would you like your funds to go?")
  }
  ...
  internal enum PhoneVerification {
    internal enum VerificationLimitReached {
      /// We've noticed multiple attempts to verify your code. For security, there's a temporary hold on further verification tries. Please wait 10 minutes before trying again.
      internal static let description = L10n.tr("Localizable", "PhoneVerification.VerificationLimitReached.Description", fallback: "We've noticed multiple attempts to verify your code. For security, there's a temporary hold on further verification tries. Please wait 10 minutes before trying again.")
      /// Verification Limit Reached
      internal static let title = L10n.tr("Localizable", "PhoneVerification.VerificationLimitReached.Title", fallback: "Verification Limit Reached")
    }
  }
  ...
  internal enum Popup {
    ...
    internal enum Statement {
      /// It normally takes a few minutes, but can sometimes be ready sooner
      internal static let description = L10n.tr("Localizable", "Popup.Statement.Description", fallback: "It normally takes a few minutes, but can sometimes be ready sooner")
      /// Your statement is being generated
      internal static let title = L10n.tr("Localizable", "Popup.Statement.Title", fallback: "Your statement is being generated")
    }
  }
  ...
  internal enum Prompts {
    internal enum Account {
      internal enum NotVerified {
        /// We were unable to complete your verification.
        internal static let body = L10n.tr("Localizable", "Prompts.Account.NotVerified.body", fallback: "We were unable to complete your verification.")
        /// Account not verified
        internal static let title = L10n.tr("Localizable", "Prompts.Account.NotVerified.title", fallback: "Account not verified")
      }
    }
    ...
    internal enum PhoneVerification {
      /// Verification helps keep your funds and information secure and allow you to buy, sell, and swap seamlessly.
      internal static let body = L10n.tr("Localizable", "Prompts.PhoneVerification.body", fallback: "Verification helps keep your funds and information secure and allow you to buy, sell, and swap seamlessly.")
      /// Phone number not verified
      internal static let title = L10n.tr("Localizable", "Prompts.PhoneVerification.title", fallback: "Phone number not verified")
    }
  ...
  internal enum Segment {
    /// Crypto assets
    internal static let cryptoAssets = L10n.tr("Localizable", "Segment.CryptoAssets", fallback: "Crypto assets")
    /// RockWallet PRO
    internal static let rockWalletPro = L10n.tr("Localizable", "Segment.RockWalletPro", fallback: "RockWallet PRO")
    /// USD account
    internal static let usdAccount = L10n.tr("Localizable", "Segment.UsdAccount", fallback: "USD account")
  }
  ...
  internal enum Sell {
    ...
    /// Sell preview
    internal static let orderPreview = L10n.tr("Localizable", "Sell.OrderPreview", fallback: "Sell preview")
    /// Conversion rate
    internal static let rate = L10n.tr("Localizable", "Sell.rate", fallback: "Conversion rate")
    /// Sell fee
    internal static let sellFee = L10n.tr("Localizable", "Sell.sellFee", fallback: "Sell fee")
  ...
  internal enum Swap {
    ...
    internal enum SwapLimits {
      /// Currently, minimum for Swap is %@ and maximum is %@ lifetime.
      internal static func lifetime(_ p1: Any, _ p2: Any) -> String {
        return L10n.tr("Localizable", "Swap.SwapLimits.Lifetime", String(describing: p1), String(describing: p2), fallback: "Currently, minimum for Swap is %@ and maximum is %@ lifetime.")
      }
    }
  }
  ...
  internal enum USDAccount {
    internal enum PaymentOption {
      /// You have %@ available
      internal static func balance(_ p1: Any) -> String {
        return L10n.tr("Localizable", "USDAccount.PaymentOption.Balance", String(describing: p1), fallback: "You have %@ available")
      }
      /// Instant availability of funds to buy digital assets
      internal static let benefit1 = L10n.tr("Localizable", "USDAccount.PaymentOption.Benefit1", fallback: "Instant availability of funds to buy digital assets")
      /// Pay less fees
      internal static let benefit2 = L10n.tr("Localizable", "USDAccount.PaymentOption.Benefit2", fallback: "Pay less fees")
      /// RockWallet USD Balance
      internal static let subtitle = L10n.tr("Localizable", "USDAccount.PaymentOption.Subtitle", fallback: "RockWallet USD Balance")
      /// RockWallet USD Account (Preferred)
      internal static let title = L10n.tr("Localizable", "USDAccount.PaymentOption.Title", fallback: "RockWallet USD Account (Preferred)")
      internal enum Balance {
        /// You have %@ %@ available
        internal static func ios(_ p1: Any, _ p2: Any) -> String {
          return L10n.tr("Localizable", "USDAccount.PaymentOption.Balance.ios", String(describing: p1), String(describing: p2), fallback: "You have %@ %@ available")
        }
      }
    }
  }
  ...
  internal enum Update {
    /// To keep your RockWallet experience smooth and secure, please update to the latest version.
    internal static let description = L10n.tr("Localizable", "Update.description", fallback: "To keep your RockWallet experience smooth and secure, please update to the latest version.")
    /// It just takes a few seconds!
    internal static let takesFewSeconds = L10n.tr("Localizable", "Update.takesFewSeconds", fallback: "It just takes a few seconds!")
    /// Tap the update button to proceed
    internal static let tapToProceed = L10n.tr("Localizable", "Update.tapToProceed", fallback: "Tap the update button to proceed")
    /// Update your RockWallet app
    internal static let title = L10n.tr("Localizable", "Update.title", fallback: "Update your RockWallet app")
  }
  ...
  internal enum UsdAccount {
    /// Close RockWallet USD Account
    internal static let closeAccount = L10n.tr("Localizable", "UsdAccount.closeAccount", fallback: "Close RockWallet USD Account")
    /// USD Account
    internal static let title = L10n.tr("Localizable", "UsdAccount.Title", fallback: "USD Account")
    internal enum Close {
      internal enum PendingTransactionsDialog {
        /// Please wait to perform this action until all pending transactions are completed.
        internal static let description = L10n.tr("Localizable", "UsdAccount.Close.PendingTransactionsDialog.Description", fallback: "Please wait to perform this action until all pending transactions are completed.")
        /// You Have Pending Transactions
        internal static let title = L10n.tr("Localizable", "UsdAccount.Close.PendingTransactionsDialog.Title", fallback: "You Have Pending Transactions")
      }
    }
    internal enum Create {
      /// I have read the agreement to the following:
      /// • RockWallet Agreement
      /// • Fortress Trust Consumer Disclosures
      /// • Fortress Trust Privacy Policy
      /// • Fortress Trust Account Agreement
      internal static let agreements = L10n.tr("Localizable", "UsdAccount.Create.Agreements", fallback: "I have read the agreement to the following:\n• RockWallet Agreement\n• Fortress Trust Consumer Disclosures\n• Fortress Trust Privacy Policy\n• Fortress Trust Account Agreement")
      /// Have USD funds readily available in app for faster transactions
      internal static let benefit1 = L10n.tr("Localizable", "UsdAccount.Create.Benefit1", fallback: "Have USD funds readily available in app for faster transactions")
      /// Save on fees and enjoy faster transactions with USD in your wallet
      internal static let benefit2 = L10n.tr("Localizable", "UsdAccount.Create.Benefit2", fallback: "Save on fees and enjoy faster transactions with USD in your wallet")
      /// Save time with auto-populated bank account info
      internal static let benefit3 = L10n.tr("Localizable", "UsdAccount.Create.Benefit3", fallback: "Save time with auto-populated bank account info")
      /// I read the E-Sign Agreement and understand I will not receive documents in the mail
      internal static let eSignAgreement = L10n.tr("Localizable", "UsdAccount.Create.eSignAgreement", fallback: "I read the E-Sign Agreement and understand I will not receive documents in the mail")
      /// I have read and agreed to the Fortress Trust Terms and Conditions
      internal static let fortressTerms = L10n.tr("Localizable", "UsdAccount.Create.FortressTerms", fallback: "I have read and agreed to the Fortress Trust Terms and Conditions")
      /// I read the
      internal static let iRead = L10n.tr("Localizable", "UsdAccount.Create.IRead", fallback: "I read the")
      /// Save on transfer fees and enjoy faster transactions
      internal static let subtitle = L10n.tr("Localizable", "UsdAccount.Create.Subtitle", fallback: "Save on transfer fees and enjoy faster transactions")
      /// Open a USD Account
      internal static let title = L10n.tr("Localizable", "UsdAccount.Create.Title", fallback: "Open a USD Account")
      internal enum Agreements {
        /// • RockWallet Agreement
        internal static let bold1 = L10n.tr("Localizable", "UsdAccount.Create.Agreements.bold1", fallback: "• RockWallet Agreement")
        /// • Fortress Trust Consumer Disclosures
        internal static let bold2 = L10n.tr("Localizable", "UsdAccount.Create.Agreements.bold2", fallback: "• Fortress Trust Consumer Disclosures")
        /// • Fortress Trust Privacy Policy
        internal static let bold3 = L10n.tr("Localizable", "UsdAccount.Create.Agreements.bold3", fallback: "• Fortress Trust Privacy Policy")
        /// • Fortress Trust Account Agreement
        internal static let bold4 = L10n.tr("Localizable", "UsdAccount.Create.Agreements.bold4", fallback: "• Fortress Trust Account Agreement")
        /// I have read the agreement to the following:
        internal static let iRead = L10n.tr("Localizable", "UsdAccount.Create.Agreements.IRead", fallback: "I have read the agreement to the following:")
      }
      internal enum Benefit1 {
        /// Have USD funds readily available
        internal static let bold = L10n.tr("Localizable", "UsdAccount.Create.Benefit1.bold", fallback: "Have USD funds readily available")
      }
      internal enum Benefit2 {
        /// Save on fees
        internal static let bold = L10n.tr("Localizable", "UsdAccount.Create.Benefit2.bold", fallback: "Save on fees")
        /// and enjoy faster transactions with USD in your wallet
        internal static let regular = L10n.tr("Localizable", "UsdAccount.Create.Benefit2.regular", fallback: "and enjoy faster transactions with USD in your wallet")
      }
      internal enum Benefit3 {
        /// Save time
        internal static let bold = L10n.tr("Localizable", "UsdAccount.Create.Benefit3.bold", fallback: "Save time")
        /// with auto-populated bank account info
        internal static let regular = L10n.tr("Localizable", "UsdAccount.Create.Benefit3.regular", fallback: "with auto-populated bank account info")
      }
      internal enum FortressTerms {
        /// Fortress Trust Terms and Conditions
        internal static let bold = L10n.tr("Localizable", "UsdAccount.Create.FortressTerms.bold", fallback: "Fortress Trust Terms and Conditions")
        /// I have read and agreed to the
        internal static let regular = L10n.tr("Localizable", "UsdAccount.Create.FortressTerms.regular", fallback: "I have read and agreed to the")
      }
      internal enum Popup {
        /// Verify your identity to open a RockWallet USD Bank Account
        internal static let title = L10n.tr("Localizable", "UsdAccount.Create.Popup.title", fallback: "Verify your identity to open a RockWallet USD Bank Account")
      }
      internal enum ESignAgreement {
        /// E-Sign Agreement
        internal static let bold = L10n.tr("Localizable", "UsdAccount.Create.eSignAgreement.bold", fallback: "E-Sign Agreement")
        /// and understand I will not receive documents in the mail
        internal static let regular = L10n.tr("Localizable", "UsdAccount.Create.eSignAgreement.regular", fallback: "and understand I will not receive documents in the mail")
      }
    }
    internal enum Delete {
      internal enum Completed {
        /// You may reopen it anytime
        internal static let description = L10n.tr("Localizable", "UsdAccount.Delete.Completed.Description", fallback: "You may reopen it anytime")
        /// You have closed your RockWallet USD Account
        internal static let title = L10n.tr("Localizable", "UsdAccount.Delete.Completed.Title", fallback: "You have closed your RockWallet USD Account")
      }
      internal enum Confirmation {
        /// If you close your account you would need to reopen another USD account and redo the verification process.
        internal static let description = L10n.tr("Localizable", "UsdAccount.Delete.Confirmation.Description", fallback: "If you close your account you would need to reopen another USD account and redo the verification process.")
        /// Are you sure you want to close your RockWallet USD Account?
        internal static let title = L10n.tr("Localizable", "UsdAccount.Delete.Confirmation.Title", fallback: "Are you sure you want to close your RockWallet USD Account?")
      }
      internal enum FundsWarning {
        /// Before closing your RockWallet USD Account, move all your money to another bank or use it to buy assets in the app
        internal static let description = L10n.tr("Localizable", "UsdAccount.Delete.FundsWarning.Description", fallback: "Before closing your RockWallet USD Account, move all your money to another bank or use it to buy assets in the app")
        /// Continue to Withdraw Funds
        internal static let secondaryButton = L10n.tr("Localizable", "UsdAccount.Delete.FundsWarning.SecondaryButton", fallback: "Continue to Withdraw Funds")
        /// Withdraw Funds From Your RockWallet USD Account
    ...
    internal enum DepositAction {
      ...
      internal enum Title {
        /// Tap here to deposit more funds
        internal static let bold = L10n.tr("Localizable", "UsdAccount.DepositAction.title.bold", fallback: "Tap here to deposit more funds")
      }
    }
    internal enum Details {
      /// Account holder
      internal static let accountHolder = L10n.tr("Localizable", "UsdAccount.Details.AccountHolder", fallback: "Account holder")
      /// Account number
      internal static let accountNumber = L10n.tr("Localizable", "UsdAccount.Details.AccountNumber", fallback: "Account number")
      /// Account type
      internal static let accountType = L10n.tr("Localizable", "UsdAccount.Details.AccountType", fallback: "Account type")
      /// ACH and wire routing number
      internal static let achRoutingNumber = L10n.tr("Localizable", "UsdAccount.Details.AchRoutingNumber", fallback: "ACH and wire routing number")
      /// Fund your RockWallet USD Bank Account via domestic transfer.
      internal static let cardSubtitle = L10n.tr("Localizable", "UsdAccount.Details.CardSubtitle", fallback: "Fund your RockWallet USD Bank Account via domestic transfer.")
      /// Info for Domestic Transfers
      internal static let cardTitle = L10n.tr("Localizable", "UsdAccount.Details.CardTitle", fallback: "Info for Domestic Transfers")
      /// Copied!
      internal static let copied = L10n.tr("Localizable", "UsdAccount.Details.Copied", fallback: "Copied!")
      /// RockWallet USD Bank Account 
      /// Details
      internal static let title = L10n.tr("Localizable", "UsdAccount.Details.Title", fallback: "RockWallet USD Bank Account \nDetails")
    }
    internal enum Errors {
      /// Your RockWallet USD Account doesn’t have enough funds for this purchase.
      internal static let tooLowUsdBalance = L10n.tr("Localizable", "UsdAccount.Errors.tooLowUsdBalance", fallback: "Your RockWallet USD Account doesn’t have enough funds for this purchase.")
    }
    internal enum Home {
      /// Transaction History
      internal static let transactionHistory = L10n.tr("Localizable", "UsdAccount.Home.TransactionHistory", fallback: "Transaction History")
      internal enum Deposit {
        /// View USD account transfer info
        internal static let description = L10n.tr("Localizable", "UsdAccount.Home.Deposit.Description", fallback: "View USD account transfer info")
        /// Deposit
        internal static let title = L10n.tr("Localizable", "UsdAccount.Home.Deposit.Title", fallback: "Deposit")
      }
      internal enum Withdraw {
        /// Withdraw your USD
        internal static let description = L10n.tr("Localizable", "UsdAccount.Home.Withdraw.Description", fallback: "Withdraw your USD")
        /// Withdraw
    ...
    internal enum Status {
      ...
      /// The RockWallet USD Bank Account enables you to store and withdraw USD within our app!
      internal static let description = L10n.tr("Localizable", "UsdAccount.Status.Description", fallback: "The RockWallet USD Bank Account enables you to store and withdraw USD within our app!")
      /// Account Status: %@
      internal static func title(_ p1: Any) -> String {
        return L10n.tr("Localizable", "UsdAccount.Status.Title", String(describing: p1), fallback: "Account Status: %@")
      }
      /// Verification in progress
      internal static let verificationInProgress = L10n.tr("Localizable", "UsdAccount.Status.VerificationInProgress", fallback: "Verification in progress")
    }
    internal enum Success {
      /// Start using your USD balance by transferring funds to the account
    ...
    internal enum Transactions {
      /// Generate statement
      internal static let generateStatement = L10n.tr("Localizable", "UsdAccount.Transactions.GenerateStatement", fallback: "Generate statement")
      /// View all transactions
      internal static let viewAllButton = L10n.tr("Localizable", "UsdAccount.Transactions.ViewAllButton", fallback: "View all transactions")
    }
    internal enum Withdraw {
      /// The amount you entered for withdrawal exceeds the balance in your RockWallet USD Account.
      internal static let amountTooHigh = L10n.tr("Localizable", "UsdAccount.Withdraw.AmountTooHigh", fallback: "The amount you entered for withdrawal exceeds the balance in your RockWallet USD Account.")
      /// Withdraw
      internal static let title = L10n.tr("Localizable", "UsdAccount.Withdraw.Title", fallback: "Withdraw")
      internal enum Details {
        /// Withdraw details
        internal static let title = L10n.tr("Localizable", "UsdAccount.Withdraw.Details.Title", fallback: "Withdraw details")
      }
    }
  }
  ...
  internal enum VerifyAccount {
    ...
    internal enum ExpressVerification {
      /// Verification helps keep your funds and information secure and allow you to buy, sell and swap seamlessly.
      internal static let description = L10n.tr("Localizable", "VerifyAccount.ExpressVerification.description", fallback: "Verification helps keep your funds and information secure and allow you to buy, sell and swap seamlessly.")
      /// Express Verification
      internal static let title = L10n.tr("Localizable", "VerifyAccount.ExpressVerification.title", fallback: "Express Verification")
    }
    internal enum Veriff {
      internal enum Action {
        /// Get Verify
        internal static let title = L10n.tr("Localizable", "VerifyAccount.Veriff.Action.title", fallback: "Get Verify")
      }
    }
  }
  internal enum VerifyPhoneNumber {
    /// This code has expired, please request to resend your code and try again
    internal static let codeExpired = L10n.tr("Localizable", "VerifyPhoneNumber.CodeExpired", fallback: "This code has expired, please request to resend your code and try again")
    /// Please enter the code we've sent to: %@
    internal static func enterCode(_ p1: Any) -> String {
      return L10n.tr("Localizable", "VerifyPhoneNumber.EnterCode", String(describing: p1), fallback: "Please enter the code we've sent to: %@")
    }
    ...
    internal enum Number {
      ...
      internal static let invalid = L10n.tr("Localizable", "VerifyPhoneNumber.Number.invalid", fallback: "Please enter a valid phone number")
    }
    ...
    internal enum Sms {
      /// Change my number
      internal static let changeNumber = L10n.tr("Localizable", "VerifyPhoneNumber.sms.changeNumber", fallback: "Change my number")
  ...
  internal enum Withdrawal {
    /// Withdrawal preview
    internal static let orderPreview = L10n.tr("Localizable", "Withdrawal.OrderPreview", fallback: "Withdrawal preview")
