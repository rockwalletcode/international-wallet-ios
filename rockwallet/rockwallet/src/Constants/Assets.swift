...
internal enum Asset {
  ...
  internal static let iconCustodial = ImageAsset(name: "icon-custodial")
  internal static let iconSelfCustodial = ImageAsset(name: "icon-selfCustodial")
  ...
  internal static let logoPro = ImageAsset(name: "logo-pro")
  ...
  internal static let transferFunds = ImageAsset(name: "transferFunds")
