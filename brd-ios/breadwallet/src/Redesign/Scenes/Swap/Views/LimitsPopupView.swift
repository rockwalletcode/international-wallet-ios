...
class LimitsPopupView: FEView<LimitsPopupConfiguration, LimitsPopupViewModel> {
    ...
    private lazy var dailyLineView: UIView = {
        let view = UIView()
        view.backgroundColor = LightColors.Outline.one
        return view
    }()
    
    private lazy var weeklyLineView: UIView = {
        let view = UIView()
        view.backgroundColor = LightColors.Outline.one
        return view
    }()
    ...
    override func setupSubviews() {
        ...
        mainStack.setCustomSpacing(Margins.huge.rawValue, after: titleView)
        
        mainStack.addArrangedSubview(titleLineView)
        ...
        mainStack.addArrangedSubview(dailyLineView)
        dailyLineView.snp.makeConstraints { make in
            make.height.equalTo(ViewSizes.minimum.rawValue)
        }
        ...
        mainStack.addArrangedSubview(weeklyLineView)
        weeklyLineView.snp.makeConstraints { make in
            make.height.equalTo(ViewSizes.minimum.rawValue)
        }
